    ...
    public partial class Form1 : Form
    {
        ...
        private void drawHistogram(Dictionary<Interval, int> distribution, EditableRectangle r, Graphics g, string text)
        {
            ...
            foreach (KeyValuePair<Interval, int> kv in distribution)
            {
                ...
                g.DrawRectangle(Pens.Violet, histrect);

                X += size;
            }

            Rectangle stringPos = new Rectangle(r.r.Left, r.r.Top - 2 * (r.r.Height / 5), r.r.Width, r.r.Height / 5);
            Font font1 = new Font("Courier New", 12, FontStyle.Regular, GraphicsUnit.Pixel);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            drawHistogram(normal_distribution, r1, g, "Normal Distribution");
            drawHistogram(chisquared_distribution, r2, g, "Chi-squared Distribution");
            drawHistogram(cauchy_distribution, r3, g, "Cauchy Distribution");
            drawHistogram(Ffisher_distribution, r4, g, "Fischer distribution");
            drawHistogram(Tstudent_distribution, r5, g, "T-student distribution");
            pictureBox1.Image = b;
        }
